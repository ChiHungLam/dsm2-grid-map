...
/**
 * A class representing a square piece of a digtial elevation model. This particular one is specifically
 * a 10 x 10 grid representing points which are in the x,y direction similar to ASCII Grid format with
 * a grid size of 10m assumed. The elevation points themselves are returned in feet but are stored internally
 * in tenths of a foot
 * @author nsandhu
 *
 */
...
public class DEMGridSquare implements Serializable{
	...
	public List<DataPoint> getElevationsAlongLine(double x1, double y1, double x2, double y2){
		return null;
	}
	/**
